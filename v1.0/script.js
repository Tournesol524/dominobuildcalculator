...
document.querySelector('.languages_menu').addEventListener('click', function() {
document.querySelector('.languages_selection').classList.toggle('rotate');
});

// --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

// TextContent
document.querySelector('#title').textContent = "Domino Build Calculator"
document.querySelector('#subtitle').textContent = "Calculate the dominoes needed for a lot of 3d and 2d constructions"
document.querySelector('#more_content').textContent = "More content soon !"
document.querySelector('.channel_name').textContent = "LDominoes"
document.querySelector('.Error2').textContent = "Other languages are not yet available";
document.querySelector('.Error4').textContent = "OK"